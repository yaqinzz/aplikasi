...
<h1>Edit Book</h1>
    ...
    <div class="mt-5 w-50">
        ...
        <form action="/book-edit/{{ $book->slug }}" method="post"enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="currentImage" class="form-label" style="display: block">Curent Image</label>
                @if ($book->cover !='')
                <img src="{{ asset('storage/cover/'.$book->cover) }}" width="300px">
                @else
                <img src="{{ asset('images/1.jpg') }}" width="300px">
                @endif
            </div>
            ...
            <div class="mb-3">
                <label for="curentCategory" class="form-label">Curent Category</label>
                <ul>
